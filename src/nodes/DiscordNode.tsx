    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          placeholder="📊 {{market}} hit {{price}} — {{direction}} your threshold"
    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="badge-discord text-xs px-1.5 py-0.5 rounded font-mono-feature">ACTION</span>
        </div>
